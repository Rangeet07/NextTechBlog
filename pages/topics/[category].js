            ...
            <div className="container">
                <div className="category_title">
                    <div className="flex gap-1">
                        ...
                        publishedblogs && publishedblogs[0]?.blogcategory : publishedblogs && publishedblogs.blogcategory }</h1>
                        <span>{loading ? <div>0</div> : publishedblogs.filter(blog => blog.blogcategory).length }</span>
                    </div>
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Praesentium laudantium veniam iusto. Eius harum, reiciendis tempora quaerat quibusdam maxime iste iure eaque. Accusantium esse quidem autem cumque nesciunt odio amet.</p>
                </div>
